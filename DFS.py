...
#empty stack that will eventually be filled 
dfsStack = []
...
#we insert our rootnode first in the stack  
...
while len(dfsStack) != 0:
    ...
    if currentNode.depth < maximumDepth:
        ...
        if currentNode.weight <= maximumWeight:
            dfsStack.append(childNode_with)
            dfsStack.append(childNode_without)
